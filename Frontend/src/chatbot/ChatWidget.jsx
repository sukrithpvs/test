                        ...
                        <div className="p-4 border-t border-white/10 bg-black/40">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="p-2.5 bg-surreal-cyan text-force-black rounded-xl hover:bg-cyan-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-surreal-cyan/20"
                                >
