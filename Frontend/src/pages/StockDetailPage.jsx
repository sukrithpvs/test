      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="text-right">
              ...
              <div className={`flex items-center justify-end gap-2 text-lg font-medium ${isPositive ? 'text-emerald-400' : 'text-coral-400'}`}>
                    ...
                    <div className="glass-card p-6 rounded-xl border border-white/5">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-coral-400 font-bold">${stock.low.toFixed(2)}</div>
                        </div>
                        <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="glass-card p-6 rounded-xl border border-white/5 text-center">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-coral-400">${stock.fiftyTwoWeekLow.toFixed(2)}</span>
                        <span className="text-emerald-400">${stock.fiftyTwoWeekHigh.toFixed(2)}</span>
                      </div>
                      <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-coral-500 via-yellow-500 to-emerald-500"
                          style={{
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-24 space-y-6">
            ...
            >
              <div className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-br ${orderType === 'BUY' ? 'from-surreal-cyan/20' : 'from-coral-accent/20'} to-transparent blur-3xl -z-10`} />
              ...
              <div className="flex bg-black/40 p-1 rounded-xl mb-6">
                ...
                <button
                  ...
                  className={`flex-1 py-3 rounded-lg text-sm font-bold transition-all ${orderType === 'SELL' ? 'bg-coral-500 text-white shadow-lg shadow-coral-500/25' : 'text-gray-400 hover:text-white'}`}
                >
                  SELL
                </button>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      min="1"
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-4 text-xl font-bold text-white focus:outline-none focus:border-surreal-cyan transition-colors"
                    />
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 flex gap-1">
                      <button onClick={() => setQty(q => q + 1)} className="p-1 hover:bg-white/10 rounded"><Plus className="w-4 h-4 text-gray-400" /></button>
                    </div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-xl font-bold text-white text-lg shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${orderType === 'BUY' ? 'bg-emerald-500 shadow-emerald-500/25' : 'bg-coral-500 shadow-coral-500/25'}`}
                >
                  {placing ? (
